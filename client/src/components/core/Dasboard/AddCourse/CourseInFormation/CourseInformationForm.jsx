...
const CourseInformationForm = () => {
  ...
  useEffect(() => {
    ...
    //console.log("courseTags",course.courseTags)
  ...
  const onSubmit = async (data) => {
    ...
    if (editCourse) {
      if (isFormUpdated()) {
        const currentValues = getValues();
        console.log("currentValues2", currentValues);
        ...
        console.log("courseTags", currentValues.courseTags);
        console.log("courseTags2", course.tag);
